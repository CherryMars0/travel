<template>
    <div class="loginContainer animate__animated animate__fadeInLeft">
...
.loginContainer-bottom ul li {
    height: 25px;
    line-height: 30px;
}

.loginContainer-bottom ul li:nth-child(2) {
    border: 1px solid black;
}

.loginContainer-bottom a {
    color: black;
    font-size: 18px;
    line-height: 25px;
}
